...
public class FRSKPSPublicSoap
{
    interface FRSIWcfMethod
    {
        FRSExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(FRSExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public FRSKPSPublicSoap(){}

    public FRSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FRSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected FRSExtendedSoapSerializationEnvelope createEnvelope()
    {
        FRSExtendedSoapSerializationEnvelope envelope= new FRSExtendedSoapSerializationEnvelope(FRSExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,FRSExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,FRSExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final String TCKimlikNo, final String Ad, final int Soyad, final String DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new FRSIWcfMethod()
        {
            @Override
            public FRSExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                FRSExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(FRSExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(FRSIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        FRSExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,FRSExtendedSoapSerializationEnvelope envelope)
    {
