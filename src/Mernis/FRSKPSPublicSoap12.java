...
public class FRSKPSPublicSoap12
{
    ...
    public FRSKPSPublicSoap12(){}

    public FRSKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public FRSKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FRSExtendedSoapSerializationEnvelope envelope= new FRSExtendedSoapSerializationEnvelope(FRSExtendedSoapSerializationEnvelope.VER12);
